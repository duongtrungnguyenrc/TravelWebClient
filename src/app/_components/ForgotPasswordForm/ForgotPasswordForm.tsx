...
const ForgotPasswordForm = () => {
  ...
  const restorePassword = async () => {
    ...
    const response = await authServices.restorePasswordRequest(existingAccount?.email as string);
    ...
    <div className="register-site d-flex flex-column justify-content-center" >
      {
        ...
        <>
          <div className="register-site-header">
            ...
            <div>
                <h1 className="form-title">Tìm tài khoản của bạn</h1>
                <div className="description">
                Vui lòng nhập email để tìm kiếm tài khoản của bạn
                </div>
            </div>
          </div>
          <div className="register-site-frame d-flex flex-column justify-content-center">
              {
                !existingAccount ?
                ...
                :
                <Stack>
                  <Stack direction="row" className="mb-3" justifyContent="space-between">
                    <Typography>
