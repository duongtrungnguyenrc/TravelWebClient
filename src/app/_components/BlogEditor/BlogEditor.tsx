...
import { Avatar, Box, Button, Card, CardContent, CardMedia, Chip, Divider, Grid, IconButton, List, ListItem, Modal, Stack, TextField, Typography, styled } from '@mui/material';
                                ...
                                <Card className="d-flex w-100 gap-1 rounded" sx={{boxShadow: "none"}}>
                                    ...
                                    <CardContent className="p-0 d-flex flex-column justify-content-center">
                                        ...
                                        <Typography display="flex" variant="body2" color="text.secondary" marginBottom="10px" fontSize="12px" alignItems="center" gap="5px" className="mt-2">
                                            {post.author} | <CalendarTodayIcon sx={{fontSize: "12px"}}/>  { post.time.split(" ")[0] }
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </ListItem>
