...
function ProductsFilter({
    ...
    const handleFilterChange = useDebouncedCallback((e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (name.trim() === 'fromPrice' || name.trim() === 'toPrice') {
            if (name === 'toPrice') {
                setFilter((prevState) => ({
                    ...prevState,
                    [name]: 15000000 - parseFloat(value),
                }));
            } else {
                setFilter((prevState) => ({
                    ...prevState,
    ...
    return (
        <div className={cx('side-bar')}>
            ...
            <form method="post" onSubmit={handleApplyFilter}>
                <ul>
                    <li>
                        <p className={cx({ active: activeOptions?.includes(0) })}>
                            Đánh giá
                        ...
                        <div className={cx('sub-list-side')}>
                            {[1, 2, 3, 4, 5].map((star) => {
                                return (
                                    <label key={star} className={cx('item-sub-list')}>
                                        <input
                                            className="field-cat"
                                            type="radio"
                                            name="star"
                    ...
                    <li>
                        <p className={cx({ active: activeOptions?.includes(1) })}>
                            Thời gian
                    ...
                    <li>
                        <p className={cx({ active: activeOptions?.includes(2) })}>
                            Mức giá
                    ...
                    <li>
                        <p className={cx({ active: activeOptions?.includes(3) })}>
                            Hạng vé
                ...
                <div className={cx('btn-group')}>
                    <Button variant="contained" type="reset" onClick={handleResetFilter}>
                        Bỏ lọc
                    </Button>
