        ...
        <div className="bottom-left-header">
          ...
          <div className="input-bottom">
            <form action="">
              ...
              />
              <button className="btn btn-yellow btn-bottom" type="submit">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id=" Round / Content / send">
                    <path id="&#240;&#159;&#148;&#185;Icon Color" fillRule="evenodd" clipRule="evenodd" d="M3.4 20.4L20.85 12.92C21.66 12.57 21.66 11.43 20.85 11.08L3.4 3.60002C2.74 3.31002 2.01 3.80002 2.01 4.51002L2 9.12002C2 9.62002 2.37 10.05 2.87 10.11L17 12L2.87 13.88C2.37 13.95 2 14.38 2 14.88L2.01 19.49C2.01 20.2 2.74 20.69 3.4 20.4Z" fill="white"/>
                  </g>
                </svg>
              </button>
            </form>
            <div className="sub-bottom">
              <p className="sub-content">Copyright Tanah Air Studio</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <ul className="list-infor">
              <li>
                <ul className="detail-one">
                  <li className="detail-list">Home</li>
                  <li className="detail-list">Room & Suites</li>
                  <li className="detail-list">Packages</li>
                  <li className="detail-list">Voucher</li>
                  <li className="detail-list">Promo</li>
                </ul>
              </li>
              <li>
                <ul className="detail-two">
                  <li className="detail-list">About Us</li>
                  <li className="detail-list">Restaurant & Bar</li>
                  <li className="detail-list">Events</li>
                  <li className="detail-list">Gallery</li>
                </ul>
              </li>
              <li>
                <ul className="detail-three">
                  <li className="detail-list">Our Team</li>
                  <li className="detail-list">Blog</li>
                  <li className="detail-list">Contact Us</li>
                  <li className="detail-list">Careers</li>
                </ul>
              </li>
            </ul>
          </div>
