        ...
        <div className="bottom-left-header">
          ...
          <div className="bottom-left-body">
            <form action="">
              ...
              />
              <button className="btn btn-yellow btn-big btn-normal" type="submit">
          ...
          <div className="bottom-left-footer">
            <p className="copyright">© Copyright Javalorant Team</p>
          </div>
        </div>
      </div>
          ...
          <ul className="quick-links">
            <li>
              <ul className="detail-one">
                ...
                <li className="detail-list">Room</li>
            ...
            <li>
              <ul className="detail-two">
                ...
                <li className="detail-list">Restaurant</li>
