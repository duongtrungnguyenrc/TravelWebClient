...
const BookingForm = ({
    ...
    tourDateId: number;
    tour: Tour;
    sessionResultInfo?: { sessionToken: string; status: string; orderId: string };
}) => {
    ...
    useEffect(() => {
        if (
            ...
            existingSessionToken != '' &&
            existingSessionToken === sessionResultInfo?.sessionToken
        ) {
    ...
    const handleNewOrderCustomerNameChange = useDebouncedCallback((e) => {
    ...
    function calculateTotalPrice(): number {
        ...
        if (currentTourDate && newOrder && tour) {
            totalPrice +=
                +newOrder?.adults * currentTourDate.adultPrice +
                (newOrder?.children ? +newOrder?.children : 0) * currentTourDate.childPrice;
            ...
            if (newOrder?.hotelId !== -1 && tour?.hotels) {
                ...
                if (selectedHotel && selectedHotel.rooms) {
                    ...
                    if (selectedRoom) {
                        totalPrice +=
                            selectedRoom.price * (+newOrder?.adults || 0) +
                            (selectedRoom.price / 2) * (+newOrder?.children || 0);
                    }
                }
            }
        }
                        ...
                        <div className="bill-detail border rounded p-4">
                            ...
                            <div className="input-group mt-3">
                                ...
                                <TextField
                                    ...
                                    required
                                    onChange={handleNewOrderCustomerInforChange}
                                />
                            </div>
                            <div className="input-group mt-3">
                                <label>
                            ...
                            <div className="w-100 d-flex mt-3">
                                ...
                                <div className="input-group col-6 p-0 pl-2">
                                    ...
                                    <FormControl>
                                        <Select displayEmpty name="district" onChange={handleAddressChange} required>
                            ...
                            <div className="d-flex flex-column gap-2">
                                ...
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            onChange={(e) =>
                                                setIsIncludeHotel((e as ChangeEvent<HTMLInputElement>).target.checked)
                                            }
                                        />
                                    }
                                    ...
                                    <div className="multi-group">
                                        <FormControl className="input-group">
                                            <Select
                                                ...
                                                inputProps={{ 'aria-label': 'Without label' }}
                                                onChange={handleDataChange}>
                                                <MenuItem defaultChecked>Chọn khách sạn</MenuItem>
                                                {tour?.hotels?.map((hotel) => {
                                                    return (
                                                        <MenuItem value={hotel.id}>
                                        ...
                                        <FormControl className="input-group">
                                            <Select
                                                ...
                                                {newOrder.hotelId &&
                                                    tour?.hotels
                                                        ?.find((hotel) => hotel.id == newOrder.hotelId)
                                                        ?.rooms.map((room) => {
                                                            return (
                                                                <MenuItem value={room.type}>
                                ...
                                <FormControl>
                                    ...
                                    <RadioGroup
                                        ...
                                        <FormControlLabel
                                            ...
                                            label="Tiền mặt (Vé sẽ được kích hoạt khi thanh toán)"
                                        />
                                        <FormControlLabel
                                            value="vnpay"
                                            control={<Radio required />}
                                            label="Chuyển khoản qua VNpay (Mọi thông tin về giao dịch đều được bảo mật và mã hóa.)"
                                        />
                                        <FormControlLabel
                                            value="paypal"
                                            control={<Radio required />}
                                            label="Chuyển khoản qua Paypal (Mọi thông tin về giao dịch đều được bảo mật và mã hóa.)"
                                        />
                                    </RadioGroup>
                                </FormControl>
                                <div className="input-group">
                    ...
                    <div className="ticket rounded">
                        <table className="w-100">
                            ...
                            <tr className="mt-2">
                                ...
                                <td>{currentTourDate?.departDate}</td>
                            </tr>
                            <tr>
                                <td>
                                    <Typography className="title">Ngày kết thúc:</Typography>
                                </td>
                                <td>{currentTourDate?.endDate}</td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span>
                                        ...
                                        <span className="text-primary-yellow">
                                            <b>{currentTourDate?.adultPrice.toLocaleString('vn')} VNĐ</b>
                                        </span>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span>
                                        {newOrder?.children} x{' '}
                                        <span style={{ color: '#c7923e' }}>
                                            <b>{currentTourDate?.childPrice.toLocaleString('vn')} VNĐ</b>
                                        </span>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span className="text-primary-yellow">
                                        {newOrder?.paymentMethod.toLocaleUpperCase()}
                                    </span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            {ticketExpanded && (
                                <>
                                    ...
                                    <tr>
                                        <td>
                                            <Typography className="title">Điện thoại:</Typography>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <Typography className="title">Địa chỉ:</Typography>
                                        </td>
                                                    ...
                                                    <table className="w-100">
                                                        <tr>
                                                            <td style={{ width: '100px' }}>
                                                                <img
                                                                    className="hotel-img"
                                                                    src={chosenHotel?.illustration}
                                                                    alt="hotel"
                                                                />
                                                            </td>
                                                            <td className="text-end">
                                                                <p>
                                                                    <b>{chosenHotel?.name}</b>
                                                                </p>
                                                                <p className="mt-2">
                                                                    <span className="text-primary-yellow">
                                                                        <b>
                                                                            {
                                                                                chosenHotel?.rooms.find(
                                                                                    (room) =>
                                                                                        room.type == newOrder.roomType
                                                                                )?.price
                                                                            }{' '}
                                                                            VNĐ
                                                                        </b>
                            ...
                            <tr>
                                <td colSpan={2} className="text-end">
                                    <h4 className="text-primary-yellow">
                                        Tổng cộng:
                                ...
                                <td>
                                    <IconButton onClick={() => setTicketExpanded((prevState) => !prevState)}>
                                        <ExpandMoreIcon
                                            sx={{
                                                transition: '0.3s',
                                                transform: ticketExpanded ? 'rotate(180deg)' : 'none',
                                            }}
                                        />
                                    </IconButton>
                                </td>
