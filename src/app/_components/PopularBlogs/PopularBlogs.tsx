...
const PopularBlogs = () => {
    return (
        <section className="popular-blogs-site">
            <div className="popular-blogs-header">
                <h1 className="blog-heading">Popular</h1>
            </div>
            <div className="popular-blogs-body">
                <Link href="" className="blog">
                    <div className="blog-hero">
                        <img
                            src="https://cdn.tuoitre.vn/zoom/480_300/2021/6/1/covid-tphcm-xet-nghiem-2-16225587987302091087680-crop-16227129239711954200938.jpg"
                            alt=""
                        />
                    </div>
                ...
                <Link href="" className="blog">
                    <div className="blog-hero">
                        <img
                            src="https://nld.mediacdn.vn/291774122806476800/2021/9/7/3-chot-3-1630978256337659996993.jpg"
                            alt=""
                        />
                    </div>
                    <div className="blog-content">
                ...
                <Link href="" className="blog">
                    <div className="blog-hero">
                        <img
                            src="https://www.chudus.vn/uploads/tra01/news/2023/05/22/e12d2f45893d372ad8066bc075ee2960.jpeg"
                            alt=""
                        />
                    </div>
                    <div className="blog-content">
